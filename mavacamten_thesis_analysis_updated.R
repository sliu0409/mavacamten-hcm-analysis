...
# 0-15 months after mavacamten initiation.
# Patient-level random intercept accounts for repeated measurements.
...
# Genotype-specific monthly slopes
...
# Model-estimated trajectories for plotting
